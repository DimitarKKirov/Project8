...
public class LillyHomeProductsPageList {
    ...
    public void userIsInHomeProductsShoppingList() {
        driver = BrowserManager.getBManager().browserDrivers().startBrowser("https://shop.lillydrogerie.bg/customer/account/login/referer/aHR0cHM6Ly9zaG9wLmxpbGx5ZHJvZ2VyaWUuYmcv/", "chrome");
    ...
    public void addItemsToTheBasket() throws InterruptedException {
        manager = new PageManager(driver);
        manager.lillyHomeProductsPage().clickBuy(driver);
        manager.lillyHomeProductsPage().clickItem(driver);
        Thread.sleep(5000);
