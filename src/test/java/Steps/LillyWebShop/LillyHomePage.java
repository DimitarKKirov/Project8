...
public class LillyHomePage {
    ...
    public void homePage() {
        ...
        driver = ContextSharing.getContext().browserManager().browserDrivers().startBrowser("https://shop.lillydrogerie.bg/", browsersType.name());
    ...
    public void logIn() {
       ...
       driver = ContextSharing.getContext().browserManager().browserDrivers().startBrowser("https://shop.lillydrogerie.bg/customer/account/login/referer/aHR0cHM6Ly9zaG9wLmxpbGx5ZHJvZ2VyaWUuYmcv/",browser.name());
        manager = new PageManager(driver);
